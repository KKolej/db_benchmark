...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=2000, help='Batch size for data operations')
    parser.add_argument('--clients', type=int, default=3, help='Number of parallel clients')
